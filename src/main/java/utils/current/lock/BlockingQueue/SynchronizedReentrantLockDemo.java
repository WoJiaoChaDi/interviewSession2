...
/**
 * synchronized 和 lock 有什么区别？用新的lock有什么好处？你举例说说
 * 1. 原始构成
 ...
 *
 * 2. 使用方法
 *      sychronized 不需要用户去手动释放锁，当synchronized 代码执行完后系统会自动让线程释放对锁的占用
 ...
 * 5. 锁绑定多个条件Condition
 *      synchronized没有
 *      ReentrantLock用来实现分组唤醒需要唤醒的线程们，可以精确唤醒，而不是像synchronized那样要么随机唤醒一个线程，要么唤醒全部线程。
 *
